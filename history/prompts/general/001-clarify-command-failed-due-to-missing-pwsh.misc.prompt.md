---
id: 001
title: Clarify command failed due to missing pwsh
stage: misc
date: 2025-12-07
surface: agent
...
I'm unable to run the prerequisite check script because `pwsh` (PowerShell) was not found. Please ensure PowerShell is installed and accessible in your system's PATH.

## Outcome

- ✅ Impact: Blocked on prerequisite
- 🧪 Tests: N/A
- 📁 Files: N/A
- 🔁 Next prompts: User to install pwsh
- 🧠 Reflection: Need to handle missing pwsh gracefully and inform user.

## Evaluation notes (flywheel)

- Failure modes observed: Missing dependency (pwsh)
- Graders run and results (PASS/FAIL): N/A
- Prompt variant (if applicable): N/A
- Next experiment (smallest change to try): Improve prerequisite checking or provide installation instructions.
